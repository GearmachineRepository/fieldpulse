    ...
    <div style={{ minHeight: "100vh", background: "#FAFBFC", fontFamily: T.font }}>
      ...
      <div style={{
        ...
        <div style={{ flex: 1 }}>
          <div style={{
            ...
            borderRadius: 3, padding: "6px 14px", marginBottom: 24,
          }}>
            <Zap size={14} color={T.accent} />
            <span style={{ fontSize: 13, fontWeight: 600, color: T.accent }}>Go paperless with your crews</span>
          </div>
          <h1 style={{ fontSize: isMobile ? 36 : 52, fontWeight: 600, lineHeight: 1.1, letterSpacing: "-1.5px", margin: "0 0 20px", color: T.text }}>
          ...
          <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
            ...
            <button style={{
              padding: "14px 28px", borderRadius: 3, cursor: "pointer",
        ...
        {!isMobile && (
          <div style={{ flex: 1, background: T.sidebar, borderRadius: 3, padding: 24, boxShadow: T.shadowLg }}>
                  ...
                  <div key={i} style={{ flex: 1, background: T.card, borderRadius: 3, padding: "14px 16px", border: `1px solid ${T.border}` }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "start" }}>
                      <div>
                        ...
                        <div style={{ fontSize: 28, fontWeight: 600, marginTop: 4, color: T.text }}>{s.val}</div>
                      </div>
                      <div style={{ width: 32, height: 32, borderRadius: 3, background: `${s.color}12`, display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: isMobile ? "40px 20px 60px" : "60px 40px 80px" }}>
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <h2 style={{ fontSize: isMobile ? 28 : 36, fontWeight: 600, letterSpacing: "-1px", margin: 0, color: T.text }}>Everything your crews need</h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(3, 1fr)", gap: 16 }}>
          {[
            ...
            <div key={i} style={{ background: T.card, borderRadius: 3, padding: isMobile ? 22 : 28, border: `1px solid ${T.border}` }}>
              <div style={{ width: 44, height: 44, borderRadius: 3, background: T.accentLight, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 16 }}>
                <f.icon size={22} color={T.accent} />
              </div>
              <div style={{ fontSize: 17, fontWeight: 600, marginBottom: 8, color: T.text }}>{f.title}</div>
        ...
        <div style={{
          ...
          borderRadius: 3, padding: isMobile ? "28px 22px" : "40px 48px",
