...
export default function PricingPage() {
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <div
        style={{ textAlign: 'center', padding: '60px 20px 40px', maxWidth: 600, margin: '0 auto' }}
      >
        <h1
          style={{
            fontSize: 40,
      ...
      >
        ...
        {PLANS.map((plan) => (
          ...
          >
            ...
            <div style={{ fontSize: 14, color: T.textLight, marginBottom: 24 }}>
              {plan.description}
            </div>
            ...
            <button
              onClick={() => (plan.price ? navigate('/signup') : null)}
              style={{
                width: '100%',
                padding: '14px',
                borderRadius: 3,
