    ...
    >
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          ...
          <div style={{ fontSize: 26, fontWeight: 600, color: T.text, letterSpacing: '-0.5px' }}>
            CruPoint
          </div>
          <div style={{ fontSize: 14, color: T.textLight, marginTop: 4 }}>
                ...
                <>
                  <div style={{ textAlign: 'center', marginBottom: 20 }}>
                    ...
                    <div style={{ fontSize: 14, color: T.textLight, lineHeight: 1.5 }}>
                      ...
                      <strong style={{ color: T.text }}>{forgotEmail}</strong>, we sent a password
                      reset link.
                    </div>
                  </div>
                  <button
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    >
                      ...
                      <input
                        ...
                        autoFocus
                        onKeyDown={(e) => {
                          if (e.key === 'Enter' && forgotEmail.trim()) handleForgot()
                        }}
                        style={{
                          flex: 1,
                          padding: '14px 0',
