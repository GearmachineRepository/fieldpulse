    ...
    <div style={{ minHeight: '100vh', background: T.bg, fontFamily: T.font }}>
      ...
      <div style={{ background: T.sidebar, padding: '24px 20px 20px' }}>
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <div>
              <div style={{ fontSize: 13, fontWeight: 600, color: T.card }}>
      ...
      <div style={{ padding: 20, maxWidth: 430, margin: '0 auto' }}>
        ...
        {!loading && !selectedCrew && tiles && (
          <>
            <div style={{ fontSize: 16, fontWeight: 600, marginBottom: 16, color: T.text }}>
              Who's working today?
            </div>
                      ...
                      {crew.employees.slice(0, 5).map((emp, i) => (
                        <div
                          ...
                          style={{
                            ...
                            color: T.card,
                            marginLeft: i > 0 ? -8 : 0,
                            background: ['#2F6FED', '#3B82F6', '#F59E0B', '#EF4444', '#7C3AED'][
                              i % 5
                            ],
                          }}
                        >
        ...
        {selectedCrew && !selectedEmp && (
          <>
            ...
            <div style={{ fontSize: 16, fontWeight: 600, marginBottom: 4, color: T.text }}>
              {selectedCrew.name}
            </div>
              ...
              {selectedCrew.employees
                ...
                .map((emp) => (
                  ...
                  >
                    {emp.photo_filename ? (
                      <img
                        src={`/uploads/${emp.photo_filename}`}
                        alt=""
                        style={{
                          width: 40,
                          height: 40,
          ...
          <>
            ...
            <div style={{ textAlign: 'center', marginBottom: 24 }}>
              {selectedEmp.photo_filename ? (
                <img
                  src={`/uploads/${selectedEmp.photo_filename}`}
                  alt=""
                  style={{
                    width: 56,
                    height: 56,
            ...
            <div style={{ position: 'relative', marginBottom: 12 }}>
              ...
              >
                {showPin ? (
                  <EyeOff size={18} color={T.textLight} />
                ) : (
                  <Eye size={18} color={T.textLight} />
                )}
              </button>
            </div>
            {error && (
