...
export default function DashboardShell() {
  ...
  useEffect(() => {
    if (!restoring && !isAdmin) routerNavigate('/login', { replace: true })
  }, [isAdmin, restoring, routerNavigate])
  ...
  return (
    <ModulesProvider>
      <div className={s.shell}>
        {/* Section rail */}
        <DashboardRail activeSection={activeSection} onSelectSection={selectSection} />
                ...
                return (
                  <span key={i}>
                    ...
                    {isLast || !seg.path ? (
                      ...
                      <Link to={seg.path} className={s.tbPath}>
                        {seg.label}
                      </Link>
                    )}
                  </span>
