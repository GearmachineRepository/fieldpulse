...
const INCIDENT_TYPES = [
  ...
  },
  {
    ...
    icon: Eye,
    color: T.amber,
    desc: 'Close call, no injury',
  },
  {
    key: 'equipment_incident',
    label: 'Equipment Incident',
    icon: Wrench,
    color: T.purple,
    desc: 'Equipment damage or failure',
  },
  {
    key: 'property_damage',
      ...
      <div style={{ padding: '0 20px 100px', flex: 1, overflowY: 'auto' }}>
        {step === 0 && (
          <StepType
            ...
            setInjuryOccurred={setInjuryOccurred}
  ...
  return (
    <div>
      ...
      >
        ...
        <button
          onClick={() => setInjuryOccurred(!injuryOccurred)}
          style={{
            width: 44,
            height: 24,
            borderRadius: 12,
            border: 'none',
            cursor: 'pointer',
            background: injuryOccurred ? T.red : T.border,
            position: 'relative',
...
function StepPhotos({
  ...
  return (
    <div>
      ...
      <div style={{ fontSize: 13, color: T.textLight, marginBottom: 20 }}>
        Document the scene — the more photos, the better
      </div>
        ...
        {PHOTO_PROMPTS.map((prompt, i) => (
          <div
            ...
            style={{
              ...
              padding: '6px 0',
              fontSize: 13,
              color: i < photos.length ? T.accent : T.textMed,
          ...
          >
            {i < photos.length ? (
              ...
              <Camera size={14} color={T.textLight} />
            )}
            {prompt}
          </div>
        ))}
    ...
    <div>
      ...
      {investigationNotes && (
        <ReviewSection title="Investigation Notes">
          <div style={{ fontSize: 14, color: T.textMed, lineHeight: 1.5 }}>
            {investigationNotes}
          </div>
        </ReviewSection>
      )}
