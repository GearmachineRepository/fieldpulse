  ...
  return (
    <div>
      <div style={{ padding: "20px 20px 0" }}>
        <div style={{ fontSize: 22, fontWeight: 600, color: T.text, marginBottom: 4 }}>My Schedule</div>
        ...
        {DAY_LABELS.map((label, i) => {
          ...
          return (
            <button key={i} onClick={() => setSelectedDow(i)} style={{
              padding: "10px 0", minWidth: 44, borderRadius: 3, border: "none", cursor: "pointer",
      ...
      {dayStops.length > 0 && (
        <div style={{ padding: "0 20px 14px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
            <span style={{ fontSize: 12, fontWeight: 600, color: T.textLight }}>
              {completedCount}/{dayStops.length} stops
            </span>
            <span style={{ fontSize: 12, fontWeight: 600, color: completedCount === dayStops.length ? T.accent : T.textLight }}>
      ...
      <div style={{ padding: "0 20px 20px" }}>
        {loadingStops ? (
          ...
          <div style={{
            textAlign: "center", padding: 40, background: T.card, borderRadius: 3,
            border: `1.5px dashed ${T.border}`,
          }}>
            <MapPin size={32} color={T.textLight} style={{ marginBottom: 8 }} />
            <div style={{ fontSize: 15, fontWeight: 600, color: T.textMed }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            ...
            {events.length > 0 && (
              <>
                <div style={{ fontSize: 13, fontWeight: 600, color: T.textLight, marginTop: 10, marginBottom: 2, paddingLeft: 4 }}>
                  Events & Tasks
                </div>
                {events.map(ev => (
                  <div key={ev.id} style={{
  ...
  return (
    <button
      ...
      style={{
        ...
        background: T.card, borderRadius: 3, overflow: "hidden",
...
function StopDetailSheet({ stop, onComplete, onClose }) {
  ...
  return (
    <BottomSheet open={true} onClose={onClose} title={account.name || "Stop Details"}>
      ...
      <div style={{
        background: T.bg, borderRadius: 3, padding: 16, marginBottom: 14,
        ...
        <div style={{ display: "flex", gap: 8, marginTop: 14 }}>
          ...
          {account.contactPhone && (
            <a href={`tel:${account.contactPhone}`}
              style={{
                flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 6,
                padding: "10px", borderRadius: 3, border: `1.5px solid ${T.border}`,
                background: T.card, color: T.blue, fontSize: 13, fontWeight: 600,
      ...
      {hasContact && (
        <div style={{ marginBottom: 14 }}>
          <div style={{ fontSize: 12, fontWeight: 600, color: T.textLight, textTransform: "uppercase", letterSpacing: 0.8, marginBottom: 8 }}>
            Contact
          </div>
          <div style={{
            background: T.bg, borderRadius: 3, padding: 14,
            border: `1px solid ${T.border}`,
          }}>
            {account.contactName && (
      ...
      <div style={{ marginBottom: 14 }}>
        ...
        <div style={{
          ...
          <div style={{
            flex: 1, background: T.bg, borderRadius: 3, padding: 12,
            border: `1px solid ${T.border}`, textAlign: "center",
          }}>
            <div style={{ fontSize: 11, color: T.textLight, marginBottom: 2 }}>Route</div>
            <div style={{ fontSize: 13, fontWeight: 600, color: T.text }}>{stop.routeName || "—"}</div>
          </div>
          <div style={{
            flex: 1, background: T.bg, borderRadius: 3, padding: 12,
            border: `1px solid ${T.border}`, textAlign: "center",
            ...
            <div style={{ fontSize: 13, fontWeight: 600, color: T.text }}>{stop.account.estimatedMinutes || stop.estimatedMinutes || 30}m</div>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        {loadingResources ? (
          ...
          <div style={{
            textAlign: "center", padding: 20, background: T.bg, borderRadius: 3,
            border: `1.5px dashed ${T.border}`,
          }}>
