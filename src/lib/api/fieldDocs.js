...
export const createFieldDoc = (data) =>
  request('/field-docs', { method: 'POST', body: JSON.stringify(data) })
export const updateFieldDoc = (id, data) =>
  request(`/field-docs/${id}`, { method: 'PUT', body: JSON.stringify(data) })
