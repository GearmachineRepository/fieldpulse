...
export const createScheduleEvent = (d) =>
  request('/schedule-events', { method: 'POST', body: JSON.stringify(d) })
export const updateScheduleEvent = (id, d) =>
  request(`/schedule-events/${id}`, { method: 'PUT', body: JSON.stringify(d) })
